...
/* --------------------------------------------------------------------------
   ...
   and the ⋯ menu (Copy / Paste / Select all / Undo). Undo keeps a small
   per-field history, snapshotting at focus and before each mutation. The
   injected chrome carries data-demo-chrome so the docs snippet stays the
   author's markup, not the wired DOM. Runs before initDropdowns (so the
   injected menu gets its open/close) and initIcons (so the glyphs fill).
   -------------------------------------------------------------------------- */
