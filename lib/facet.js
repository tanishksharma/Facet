...
/* Theme switcher buttons: set the theme, carry it in the URL, and mark the
   active button with aria-pressed for keyboard and screen-reader users. */
function initThemeSwitches() {
  ...
  for (const button of buttons) {
    button.addEventListener("click", () => {
      ...
      else delete document.documentElement.dataset.theme; // Default theme
      setUrlParam("theme", theme || null);
      showActive();
    });
  }
  showActive();
