...
/* (docs mirror — identical to llms.txt · Description tooltip)
   ...
   element, wherever there is room, always inside the viewport — and it
   stays until the page scrolls, a tap lands anywhere else, or the same
   element is tapped again. The tap still performs the element's own
...
function initTouchTooltips() {
  ...
  document.addEventListener("click", (e) => {
    ...
    if (el === current) { hide(); return; }   // a second tap closes
    show(el);
  });
