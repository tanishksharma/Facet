...
/* Skin overrides — the theme-builder half of facet.set. Six high-level
   ...
   page NOW but leaves localStorage alone, so a per-load color cycle or a
   session-only preview never survives a reload. */
const skinStore = {
