...
const FACET_ICONS = {
  ...
  "clipboard": '<rect x="6" y="4.5" width="12" height="16" rx="2"/><rect x="9" y="2.6" width="6" height="3.6" rx="1.2"/>',
  "select": '<rect x="4" y="4" width="16" height="16" rx="2.5" stroke-dasharray="3 2.6"/>',
