/*
  ...
  The motion pack: data-parallax="depth" wires elements to
  facet.motion (pointer, scroll momentum, permission-gated tilt), and
  the idle-* classes animate the composable translate/rotate/scale
...
/* Declarative parallax: any element carrying data-parallax="depth"
   ...
   The exclusion rule is structural here: the engine owns style
...
function initNavMenu() {
  ...
  for (const nav of document.querySelectorAll(".nav-menu")) {
    ...
    // one scrim per menu, at the end of <body> (reading-order rule:
