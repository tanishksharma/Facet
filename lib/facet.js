...
function setConfig(config) {
  ...
  for (const [key, value] of Object.entries(config)) {
    ...
    } else if (["theme", "density", "language", "numbers", "motion", "transition"].includes(key)) {
...
/* --------------------------------------------------------------------------
   ICONS
   Forty-eight thin line glyphs, 24x24, 1.5px stroke, round caps — the whole
...
const FACET_ICONS = {
  ...
  // App-UI glyphs (R19): named for their real jobs so app settings and
...
window.facet = {
  version: "0.2.0",   // R19: the app-kit ergonomics release
  set: setConfig,
