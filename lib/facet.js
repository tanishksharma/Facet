...
const facetSheet = (sheet, scrim, opts = {}) => {
  ...
  const rise = open => {
    ...
    const SHUT = down
      ? `inset(0 0 100% 0 round ${radius})`    // wiped up to the top bar
      : `inset(100% 0 0 0 round ${radius})`;   // wiped down to the bottom bar
