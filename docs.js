...
function renderSnippet(article) {
  ...
  // serialize a cleaned clone: controls living on the demo surface
  // (data-demo-chrome) are docs furniture, the data-bg-surface hook is
  // this page's own wiring, and the background engines' drawn custom
  // properties are regenerated by facet.js from the data attributes —
  // none of it is snippet material
